...
import { EmployeeSchema, UserSchema } from "@/lib/schema";
...
export const UpdateEmployeeModal = ({ employee }: Props) => {
  ...
  const mutation = useMutation({
    mutationFn: (data: z.infer<typeof EmployeeSchema.Update>) =>
      updateEmployeeAction(employee.id, data),
    onSuccess: (data) =>
